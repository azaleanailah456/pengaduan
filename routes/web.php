...
// route yang hanya dapat diakses stelah login dan role nya petugas 
Route::middleware(['isLogin', 'CekRole:petugas'])->group(function() {
    ...
    Route::patch('/response/update/{report_id}', [ResponseControitller::class, 'update'])->name('response.update');
});
...
// route yang hanya dapat diakses stelah login dan role nya admin 
